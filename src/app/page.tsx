    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-[#0a0a0a] text-zinc-900 dark:text-zinc-50 font-sans selection:bg-blue-500/30">
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6 py-24 sm:py-32 flex flex-col gap-16">
        ...
        <section className="flex flex-col items-center text-center gap-6">
          ...
          <h1 className="text-5xl sm:text-7xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-zinc-900 via-zinc-700 to-zinc-900 dark:from-white dark:via-zinc-300 dark:to-white pb-2 leading-tight">
            My Agent Workspace
          </h1>
